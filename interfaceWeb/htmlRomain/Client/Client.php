<html>
	...
	<body >
		...
		<div id="page-wrap">
			<h1>Bonjour <?php echo $_POST['coucou']; ?>, heureux de vous revoir!</h1>
			<h2>Il vous reste 24,41€ sur votre compte.</h2>
		</div>

		<div id="page-wrap">
			<h2>Détails de vos mouvements de compte : </h2>
			<table id="conso">
				<tr>
					<th>Date</th>
					<th>Opération</th> 
		...
		<div id="page-wrap">
			<h2> Inscription aux évènements AEDI: </h2>
			<br>
			Je souhaite m'inscrire à l'événement : 
			<select>
